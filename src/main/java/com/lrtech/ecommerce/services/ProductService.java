...
public class ProductService {
  ...
  @Transactional(readOnly = true)
  public Page<ProductDto> searchByNameAndCategories(String name,String catname, Pageable pageable) {

    Page<Product> listProducts = productRepository.searchByNameAndCategories(name,catname, pageable);
    return listProducts.map(x -> new ProductDto(x));
